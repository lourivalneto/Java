...
public class JogoDaVelhaTeste {
    ...
    public static void iniciaJogador1(int[][] matrizJogo, String nomeJogador1) {
        ...
        String desenhoJogada1 = "";
                ...
                if (matrizJogo[linhaJogador1 - 1][colunaJogador1 - 1] == 0) {
                    ...
                    desenhoJogada1 = desenhaTabuleiro(linhaJogador1, colunaJogador1); //TENTATIVA DE DESENHAR TABULEIRO
                    System.out.println(desenhoJogada1); //TENTAIVA DE IMPRIMIR TABULEIRO RETORNADO
    ...
    public static String desenhaTabuleiro(int linha, int coluna){
        String desenho = "";
        if(linha == 1 && coluna == 1) {
            desenho = "\n\tCOLUNA 1 COLUNA 2 COLUNA 3\n"
                + "\n\t\t|\t|\n"
